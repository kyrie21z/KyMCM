...
<!-- 说明用户明确给出的比赛提交要求和附件限制。appendix/ 收录排除绘图后的完整正式求解代码；根 code/ 选择用于最终提交文档代码附录的真实代表性代码；两者都不收录绘图代码。 -->
...
<!-- 区分 appendix code 的正式流程完整性与 root code 的提交展示代表性；记录绘图排除、COPY/CURATE 来源、入口与传递依赖，以及不得改变数学语义、执行顺序、随机性、恢复规则和结果边界。 -->
