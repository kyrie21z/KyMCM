...
class LiteFullSpecExportTests(unittest.TestCase):
    ...
    def test_mirror_hashes_and_mapping(self):
        ...
        self.assertEqual(sum(len(source.mirrors) for source in mirrored), 31)
    ...
    def test_frozen_figure_references_are_exported(self):
        document = SPEC.read_text(encoding="utf-8")
        expected = {
            "final_figure_core_rules.md": ("kymcm-flowchart-selection-v1.md", "human author owns final layout", "PDF + PNG + PY + TXT"),
            ...
            "final_figure_3d.md": ("kymcm-figure-3d-v1", "PyVista", "PDF/PNG/PY/TXT"),
        }
    ...
    def test_release_surface_and_full_identity_unchanged(self):
        self.assertEqual((ROOT / "skills/kymcm-lite/VERSION").read_bytes(), b"0.10.0\n")
