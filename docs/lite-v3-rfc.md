...
> Historical KyMCM Lite 0.1.0 design record. It does not describe current 0.9.0 behavior; see `skills/kymcm-lite/docs/protocol.md`. Preserved without rewriting historical decisions.
